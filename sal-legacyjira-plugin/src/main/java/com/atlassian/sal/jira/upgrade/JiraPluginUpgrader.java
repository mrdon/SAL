 ...
 */
public class JiraPluginUpgrader
{

    public static final String BUILD = ":build";
    protected List<PluginUpgradeTask> upgradeTasks = new ArrayList<PluginUpgradeTask>();
    private static final Logger log = Logger.getLogger(JiraPluginUpgrader.class);
    ...
    protected JiraPluginUpgrader(Plugin plugin, PluginSettings pluginSettings, List<PluginUpgradeTask> upgradeTasks)
    {
        this.plugin = plugin;
