...
public class FisheyeUserManagerAccessorFactoryBean implements FactoryBean
{
    private static final ClassLoader FISHEYE_HOST_CLASSLOADER = AppConfig.class.getClassLoader();

    public Object getObject() throws Exception
    {
        return wrapService(new Class[]{FisheyeUserManagerAccessor.class}, new DefaultFisheyeUserManagerAccessor(), FISHEYE_HOST_CLASSLOADER);
    }

    public Class<?> getObjectType()
    {
        return FisheyeUserManagerAccessor.class;
    }
