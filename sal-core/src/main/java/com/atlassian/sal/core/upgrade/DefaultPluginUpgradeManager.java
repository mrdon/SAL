 ...
 *
 * NOTE: The original implementation only runs upgrade tasks when the plugins system is initialized or restarted.
 * If you use the old (deprecated) constructor you will get this behaviour.
